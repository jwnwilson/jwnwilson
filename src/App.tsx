...
const Cpu = (props) => {
  return (
    <div className="flex flex-col w-[250px] h-[250px] relative m-auto border-2 border-black bg-zinc-900 py-8 px-8 max-w-sm mx-auto rounded-xl shadow-lg space-y-2 items-center">
        ...
        <div className="absolute h-2 w-7 -top-1 bg-zinc-400" style={{left: "-28px", top: "0px"}}></div>
        <div className="absolute h-2 w-7 -top-1 bg-zinc-400" style={{left: "-28px", top: "15px"}}></div>
        <div className="absolute h-2 w-7 -top-1 bg-zinc-400" style={{left: "-28px", top: "30px"}}></div>
        <div className="absolute h-2 w-7 -top-1 bg-zinc-400" style={{left: "-28px", top: "45px"}}></div>
        <div className="absolute h-2 w-7 -top-1 bg-zinc-400" style={{left: "-28px", top: "60px"}}></div>
        <div className="absolute h-2 w-7 -top-1 bg-zinc-400" style={{left: "-28px", top: "75px"}}></div>
        <div className="absolute h-2 w-7 -top-1 bg-zinc-400" style={{left: "-28px", top: "90px"}}></div>
        <div className="absolute h-2 w-7 -top-1 bg-zinc-400" style={{left: "-28px", top: "105px"}}></div>
        <div className="absolute h-2 w-7 -top-1 bg-zinc-400" style={{left: "-28px", top: "120px"}}></div>
        <div className="absolute h-2 w-7 -top-1 bg-zinc-400" style={{left: "-28px", top: "135px"}}></div>
        <div className="absolute h-2 w-7 -top-1 bg-zinc-400" style={{left: "-28px", top: "150px"}}></div>
        <div className="absolute h-2 w-7 -top-1 bg-zinc-400" style={{left: "-28px", top: "165px"}}></div>
        <div className="absolute h-2 w-7 -top-1 bg-zinc-400" style={{left: "-28px", top: "180px"}}></div>
        <div className="absolute h-2 w-7 -top-1 bg-zinc-400" style={{left: "-28px", top: "195px"}}></div>
        <div className="absolute h-2 w-7 -top-1 bg-zinc-400" style={{left: "-28px", top: "210px"}}></div>
        <div className="absolute h-2 w-7 -top-1 bg-zinc-400" style={{left: "-28px", top: "225px"}}></div>
        <div className="absolute h-2 w-7 -top-1 bg-zinc-400" style={{right: "-28px", top: "0px"}}></div>
        <div className="absolute h-2 w-7 -top-1 bg-zinc-400" style={{right: "-28px", top: "15px"}}></div>
        <div className="absolute h-2 w-7 -top-1 bg-zinc-400" style={{right: "-28px", top: "30px"}}></div>
        <div className="absolute h-2 w-7 -top-1 bg-zinc-400" style={{right: "-28px", top: "45px"}}></div>
        <div className="absolute h-2 w-7 -top-1 bg-zinc-400" style={{right: "-28px", top: "60px"}}></div>
        <div className="absolute h-2 w-7 -top-1 bg-zinc-400" style={{right: "-28px", top: "75px"}}></div>
        <div className="absolute h-2 w-7 -top-1 bg-zinc-400" style={{right: "-28px", top: "90px"}}></div>
        <div className="absolute h-2 w-7 -top-1 bg-zinc-400" style={{right: "-28px", top: "105px"}}></div>
        <div className="absolute h-2 w-7 -top-1 bg-zinc-400" style={{right: "-28px", top: "120px"}}></div>
        <div className="absolute h-2 w-7 -top-1 bg-zinc-400" style={{right: "-28px", top: "135px"}}></div>
        <div className="absolute h-2 w-7 -top-1 bg-zinc-400" style={{right: "-28px", top: "150px"}}></div>
        <div className="absolute h-2 w-7 -top-1 bg-zinc-400" style={{right: "-28px", top: "165px"}}></div>
        <div className="absolute h-2 w-7 -top-1 bg-zinc-400" style={{right: "-28px", top: "180px"}}></div>
        <div className="absolute h-2 w-7 -top-1 bg-zinc-400" style={{right: "-28px", top: "195px"}}></div>
        <div className="absolute h-2 w-7 -top-1 bg-zinc-400" style={{right: "-28px", top: "210px"}}></div>
        <div className="absolute h-2 w-7 -top-1 bg-zinc-400" style={{right: "-28px", top: "225px"}}></div>
        {props.children}
      </div>
  )
}
